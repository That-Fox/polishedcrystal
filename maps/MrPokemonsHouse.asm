...
MrPokemonsHouse_OakScript:
	...
	checkevent EVENT_GOT_KANTO_FROM_ELM
	iftruefwd .RivalTakesChikorita
	checkevent EVENT_GOT_EEVEE_FROM_ELM
	iftruefwd .RivalTakesCyndaquil
	setevent EVENT_KANTO_POKEBALL_IN_ELMS_LAB
	end

.RivalTakesChikorita:
	setevent EVENT_EEVEE_POKEBALL_IN_ELMS_LAB
	end

.RivalTakesCyndaquil:
	setevent EVENT_JOHTO_POKEBALL_IN_ELMS_LAB
	end
